...
import { Accordion as AccordionElement } from "../../elements/accordion";
 ...
 * drive which items are expanded. Grafts Base UI's accordion behavior onto the styled `Accordion`
 * frame.
 */
export function Accordion<Value = any>(props: AccordionProps<Value>) {
  return <BaseAccordion.Root {...props} render={<AccordionElement />} />;
}
