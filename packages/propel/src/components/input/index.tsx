 ...
 * `horizontal` variant where the label sits beside the control. States are element-driven (hover /
 * focus / filled / disabled / invalid), not props — only `tone="danger"` forces the error
 * treatment.
 */
 ...
 * layout only (no `variant`); `resize-none` by default with a magnitude-driven min-height.
 */
