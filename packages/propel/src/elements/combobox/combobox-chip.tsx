...
/**
 * One selected value in the multiselect frame, shown as a removable tag: its label plus a
 * `ComboboxChipRemove`. Arrow keys move focus across chips (Base UI's behavior), so it carries the
 * standard focus ring. Base-UI-agnostic — graft in `components` via `<BaseCombobox.Chip
 * render={<ComboboxChip/>} />`.
 */
