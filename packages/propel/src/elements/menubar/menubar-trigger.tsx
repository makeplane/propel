 ...
 * default and stays icon-agnostic. It embeds no menu behavior, keeping `elements/menubar`
 * independent of the Menu primitive: a menubar composition grafts the disclosure/open behavior on
 * by rendering it as a menu trigger — `render={<Menu.Trigger />}` (the styled button stays the
 * outer element) — inside a `Menu` root within an enclosing `Menubar` that drives keyboard
 * navigation.
 */
