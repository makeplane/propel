...
// Per-axis type (for consumers), named for the axis — never re-exported from the index directly;
// the part file re-exports it.
type MeterIndicatorVariantConfig = VariantProps<typeof meterIndicatorVariants>;
export type MeterIndicatorLevel = NonNullable<MeterIndicatorVariantConfig["level"]>;
