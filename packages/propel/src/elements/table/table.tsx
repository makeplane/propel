...
import { tableModes } from "./variants";

export type { TablePinned, TableMode } from "./variants";
 ...
 * `mode` with the cells/heads via context.
 */
export function Table({ render, ...props }: TableProps) {
  const defaultProps: useRender.ElementProps<"table"> = { className: tableModes() };
