 ...
 * cluster layout, keeping `elements/toolbar` independent of the ToggleGroup primitive: a
 * composition grafts the shared-state behavior on by rendering it as a toggle group —
 * `render={<ToggleGroup />}` (the styled div stays the outer element).
 */
