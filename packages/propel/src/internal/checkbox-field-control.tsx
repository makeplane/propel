 ...
 * label-less form of the ready-made `Checkbox`. Delegating keeps the check/dash icons a
 * `components` concern; with no `label`, `Checkbox` renders just the box and lets the surrounding
 * `Field` own labeling.
 */
