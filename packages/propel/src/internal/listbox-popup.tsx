...
export const listboxPopupVariants = cva(
  "max-h-[min(var(--available-height),18rem)] min-w-(--anchor-width) origin-(--transform-origin) overflow-y-auto rounded-md border-sm border-subtle bg-layer-1 p-1 shadow-overlay-100",
);
