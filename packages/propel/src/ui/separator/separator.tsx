...
/**
 * A thin rule that visually divides content. Both adjustable axes from the design spec are
 ...
 * separator. Maps 1:1 to Base UI's `Separator` with propel's vocabulary applied.
 */
